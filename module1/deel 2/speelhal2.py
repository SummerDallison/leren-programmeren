personen = int(input("Met hoeveel personen gaan er naar de speelhal? "))

toegangsticket_prijs = 7.45

tijd_in_VR_per_person = int(input("Hoeveel tijd willen jullie in de VIP-VR GameSeat zitten? "))
